...
NICSSessionManager *NICSCore::session_manager = NULL;
NICSGameManager *NICSCore::game_manager = NULL;
...
int NICSCore::Run(void) {
  try {
    ...
    session_manager = new NICSSessionManager;
    game_manager = new NICSGameManager;
	...
	break;
      cout << "Session dump:" << endl
	   << "=============" << endl;
      session_manager->dump_session_info(cout);
      cout << "Game offer dump:" << endl
	   << "================" << endl;
      game_manager->dump_offer_info(cout);
      cout << "Game dump:" << endl
	   << "==========" << endl;
      game_manager->dump_game_info(cout);
    }
